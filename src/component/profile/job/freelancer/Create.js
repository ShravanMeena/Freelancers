...
class Create extends Component {
  ...
  createFreelancer = () => {
    ...
    axios({
      method: "POST",
      url: `https://monorbit-alpha.herokuapp.com/api/v1/profiles/job/freelancer/create/`,
      data: data,
      headers: {
      ...
      .then((res) => {
        this.props.sendSingleFreelancerProfileData(res.data);
        this.props.finish();
      })
      .catch((err) => {
        ...
        <div className='innerJobContainer'>
          <div className='jobDetailsContainer'>
            ...
            <div className='saveChangesConatiner'>
              ...
              <button onClick={this.createFreelancer}>Save Changes</button>
            </div>
          </div>
        </div>
      </div>
